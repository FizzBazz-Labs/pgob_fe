...
/**
  ...
  *
  * @checksum - 4955c09fcafd5ae973d91b59c6eeb87ec24538495c87ae1eaab267d784454cba
  * @variables - radius=rounded-lg,accentColor=blue,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/

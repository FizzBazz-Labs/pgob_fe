...
/**
  ...
  *
  * @checksum - 0b7e925957ffc5f26ce1bd5e34a390306ca4a9d76e099f33688020a8f4172a8e
  * @variables - radius=rounded-xl,accentColor=blue,colorTemperature=zinc,spacing=2,scale=sm,inputShadow=shadow,baseColorShade=500,borderShadeLightMode=200,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "color__inner": {
    ...
    "group-data-[prefix-icon]:border-zinc-200": true,
    "group-data-[suffix-icon]:border": true,
    "group-data-[suffix-icon]:border-zinc-200": true,
  ...
  "slider__minValue": {
    ...
    "[&>div>div::after]:bg-zinc-200": true,
  ...
  "multi-step__tabs": {
    ...
    "group-data-[tab-style=\"tab\"]/wrapper:border-zinc-100": true,
